function [chan_data_new, hypnogram_new] = edfx_process_time(target_dir, chan_data, hypnogram, epoch_time, fs)
    ...
    chan_data_new = chan_data(start_eeg : end_eeg);
    
    % Determine number of epochs
    number_of_epochs = length(chan_data_new)/(fs*epoch_time);
