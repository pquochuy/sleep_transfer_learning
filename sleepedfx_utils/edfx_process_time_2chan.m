function [chan_data_eeg_new, chan_data_eog_new, hypnogram_new] = edfx_process_time_2chan(meta_path, chan_data_eeg, chan_data_eog, hypnogram, epoch_time, fs)
    info_dir = [meta_path, 'info/'];
